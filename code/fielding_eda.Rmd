...
plot_histogram <- function(var, df,  bw = 1, x_max = NULL) {
  ...
  ggplot(aes_string(x = toString(var)), data = df) +
    ...
    scale_x_continuous(breaks = seq(0, x_max, bw), minor_breaks = NULL, expand = c(0,0), limits = c(0, x_max + 1)) +
...
fluidPage(
  ...
  fluidRow(column(12, plotOutput("pop_plot"))),
  fluidRow(column(12, plotOutput("gg_plot")))
